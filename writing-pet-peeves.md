...
I regret that in some early publications I was inconsisent between "Jimmy J. Lin" and "Jimmy Lin" (until I started exclusively using only the latter form).
